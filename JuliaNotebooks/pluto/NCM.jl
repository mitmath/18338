...
# ╔═╡ 029a7aff-9eb8-499a-89a9-18bff5e5bf33
NC[4]

# ╔═╡ 012c1312-4dc4-4055-b751-5d9c93e091ea
NC

# ╔═╡ 051b07c8-5d99-4df6-8c79-ad324fe6de98
s = r.^(length.(NC) .- 1)
...
# ╔═╡ 67ca859e-89a9-4e94-ab7c-166102544e91
(s'*Z)[:] 
...
# ╔═╡ 7c4710bf-cc72-4628-ab77-f4f8f02bcb24
Int.(inv(abs.(μ)))

# ╔═╡ 18c1c078-3cdc-49f2-ade3-ecd634648040
sort(μ[1,:])
...
# ╔═╡ 550f4aeb-41a1-4ea4-9cdf-3f539d485969
ω
...
# ╔═╡ 09a55bba-9556-455a-84d6-a7489ed6112a
sum(≥(ω))

# ╔═╡ 167ee4b1-900e-40f6-9797-293d17d0dc3f
nge(ω) = map(~,(≥(ω)))

# ╔═╡ ea15b9c1-e386-4d0a-ace8-e49ee4383486
findall(≥(ω))

# ╔═╡ afb4be31-f91d-4680-b3f0-9bbc44b75a31
p = [findall(nge(ω));findall(≥(ω))]

# ╔═╡ e60b5da4-64a5-42c6-9894-93b0ce2d8c5b
Z[:,p]

# ╔═╡ c7f90023-82e2-4421-9848-4bef21e7cff5
≥(ω)
...
manifest_format = "2.0"
project_hash = "3d0742d41daa8cf834db5b4a1170b223619f2b7b"
