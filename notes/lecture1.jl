...
# ╔═╡ a17fb234-1252-11ec-0935-b30346ea5906
using Distributions, Plots, PlutoUI

# ╔═╡ 81add685-fcf9-4d1f-9fa5-655576f085b0
Normal()

# ╔═╡ 560fd8a1-3c57-4533-8f29-92bd7f1b4420
let
	ν=1
	Chisq(ν)
end

# ╔═╡ fe657526-c18b-4a38-9cf3-eabe283a45f3
begin
	α=1
	β=1
	Beta(α,β)
...
# ╔═╡ 71724974-321a-4ef9-8ee7-29f9da9caf6e
rand( Normal() )

# ╔═╡ d51b72db-e34f-4c30-a2de-cd52118a676b
rand( Beta(α,β) )

# ╔═╡ 81d38353-4c58-4eea-ade5-9d4dc427fc5d
plot(x->pdf( Normal(), x) ,-5:.01:5)

# ╔═╡ a05cf80b-77d2-4416-8fa7-4d2392c4a3e8
@bind ν  Slider(1:10)

# ╔═╡ 1d3242c2-d974-4518-b224-73e3b5d25b4a
rand( Chisq(ν) )

# ╔═╡ 2ad8bd4e-bfb8-44ae-86d3-258e4d0fbb8d
plot(x->pdf( Chisq(ν), x) ,0:.01:5, xlims=(0,5), ylims=(0,1) )
