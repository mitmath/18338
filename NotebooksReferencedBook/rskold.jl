...
# ╔═╡ 4f5c4aa2-b7c2-49f2-98be-1f7bc573188b
using SparseArrays
...
# ╔═╡ 140b1006-67a1-4f12-bcad-56daf86b2c8a
let
	using LinearAlgebra
 M = 5; N = 4;
...
# ╔═╡ a9da776a-02fd-48c7-936f-9f8b65fcd6bd
begin
	x = zeros(Int,5,5)
	ii=rand(1:5); j=rand(1:5)
	x[ii,j] = 1
	ii=rand(1:5); j=rand(1:5)
	x[ii,j] = 1
	# ii=rand(1:5); j=rand(1:5)
...
# ╔═╡ 5b0f9498-d87d-45be-bd67-a1402b69b3c2
x

# ╔═╡ 63e833e9-2c35-4325-a261-983e214144ec
rsk_pair(x)

# ╔═╡ fd4b8d63-f0d8-4578-a4d4-4d20bda8d884
(j,ii)

# ╔═╡ 9ba1fbb1-3858-4ba5-81b9-2c65a857bec9
sum(x)

# ╔═╡ eb0f2834-99a3-4a3f-9c0d-9bbee7c20092
I(3)

# ╔═╡ 2cceae2b-5c43-4536-9e76-0160a856c60b
I
...
# ╔═╡ 30e37383-a43c-45ed-b970-e6eab8b4f307
rand(1:5,4,3)

# ╔═╡ 8c1c8ccc-2c8f-4eba-b193-f0307b28d264
a = randn(16000,16000)
...
manifest_format = "2.0"
project_hash = "9cffaca56a3664376c10ea5b65ca25a2985d78a2"
